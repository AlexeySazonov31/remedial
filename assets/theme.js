...
theme.Slideshow = (function() {
  ...
  function removeRoleAttributes() {
      console.log(this.$slideshow.find('[role]'));
      this.$slideshow.find('[role]').removeAttr('role');
  }
...
theme.init = function() {
  ...
  sections.register('textanimation',theme.HoverMenu);
    ...
    if (wishlistObject.length > 0){
      for (var i = 0; i < wishlistObject.length; i++) { 
        ...
        Shopify.getProduct(productHandle,function(product){
          ...
          htmlProduct += '	</a>';
          htmlProduct += '	<div><a href="'+ product.url +'" class="title-prouct d-block font-family-2 h5" >'+ product.title +'</a>';
    ...
    if (arrayProduct.length > 0){
      ...
      for (var i = 0; i < arrayProduct.length; i++) {
        ...
        Shopify.getProduct(productHandle,function(product){
          ...
          htmlProduct += '		<h5 class="mb-2 mt-2"><a href="'+ product.url +'">'+ product.title +'</a></h5>';
          htmlProduct += '	<span> '+ productPrice +'</span>';
