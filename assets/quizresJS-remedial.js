...
const arrRecomedation = [
  ...
  },
  {
    ...
    rightContent:
      '<h4 class="productRightText1">Anti-Aging Moisturizing Retinol Cream for Face</h4><h5 class="productRightText2">Deeply moisturizes & restores</h5><div class="productRightBlockAMPM"><div><img src="" alt="am">AM</div><div><img src="" alt="am">PM</div></div><hr class="productRightLine"><h6 class="productRightText3">Key ingredients</h6><div class="productRightBlockKeyIngr"><div><img src="" alt="am">Retinol</div><div><img src="" alt="am">Collagen</div></div>',
  },
  {
    name: "dark spot",
    content:
