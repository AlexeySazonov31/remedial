...
const arrRecomedation = [
  {
    ...
    rightContent:
      '<hr class="productRightLineMb"><h4 class="productRightText1">Anti-Aging Moisturizing Retinol Cream for Face</h4><h5 class="productRightText2">Deeply moisturizes & restores</h5><div class="productRightBlockAMPM"><div><img src="https://cdn.shopify.com/s/files/1/0566/4322/3596/files/AMquizRes.png?v=1674204622" alt="am">AM</div><div><img src="https://cdn.shopify.com/s/files/1/0566/4322/3596/files/PMquizRes.png?v=1674204622" alt="pm">PM</div></div><hr class="productRightLine"><h6 class="productRightText3">Key ingredients</h6><div class="productRightBlockKeyIngr"><div><img src="https://cdn.shopify.com/s/files/1/0566/4322/3596/files/sliderQz2.png?v=1672992919" alt="rtSmQz">Retinol</div><div><img src="https://cdn.shopify.com/s/files/1/0566/4322/3596/files/sliderQz4.png?v=1672993225" alt="clSmQz">Collagen</div><div><button class="productRightText3" style="background-color: #1AACC7;border: none;color: white;min-height: 50px;border-radius: 20px;margin-top: 35px;">Buy of 40%</button></div></div>',
  },
  {
    name: "eye cream",
