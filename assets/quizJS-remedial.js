...
function showQuestion() {
  if (questionIndex < questions.length) {
    ...
    if (questionIndex == 0) {
      ...
      ContainerForBottomButtons.classList.add("buttonsRow");
      ContainerForAnswers.innerHTML =
        "<div class='quistion6ImgBlock'><img src='https://cdn.shopify.com/s/files/1/0566/4322/3596/files/answer-6-Primary.png?v=1671791283' id='primQz6'><img src='https://cdn.shopify.com/s/files/1/0566/4322/3596/files/answer-6-face.png?v=1674225152' id='Qz6-1'><img src='https://cdn.shopify.com/s/files/1/0566/4322/3596/files/answer-6-face_09517dd2-db80-4983-968c-e188e381ef2e.png?v=1672215699' id='Qz6-2'><img src='https://cdn.shopify.com/s/files/1/0566/4322/3596/files/answer-6-tzona.png?v=1671791283' id='Qz6-3'><img src='https://cdn.shopify.com/s/files/1/0566/4322/3596/files/answer-6-neck.png?v=1674224716' id='Qz6-4'><img src='https://cdn.shopify.com/s/files/1/0566/4322/3596/files/answer-6-all.png?v=1671791283' id='Qz6-5'></div><div class='answers6withImg'><button class='itemAnswer' id='0'>Eyes</button><button class='itemAnswer' id='1'>Face</button><button class='itemAnswer' id='2'>T-zone</button><button class='itemAnswer' id='4'>Neck</button><button class='itemAnswer' id='3'>All together</button><button class='itemAnswer' id='5'>No problems</button></div>";
